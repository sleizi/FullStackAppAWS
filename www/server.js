...
(() => __awaiter(this, void 0, void 0, function* () {
    ...
    app.get("/filteredimage", (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (validateURL(image_url)) {
            const filterImg = yield util_1.filterImageFromURL(image_url);
            res.sendFile(filterImg, function (err) {
                if (err) {
                    res.status(406).send("Error occured while accessing the image!");
                }
                else {
                    util_1.deleteLocalFiles([filterImg]);
                }
            });
        }
        else
            res.status(404).send("Invalid image URL!");
    }));
    // Root Endpoint
